...
// Command     : write_verilog -force -mode synth_stub -rename_top commandFIFO -prefix
//               commandFIFO_ commandFIFO_stub.v
// Design      : commandFIFO
...
/* synthesis syn_black_box black_box_pad_pin="clk,din[39:0],wr_en,rd_en,dout[39:0],full,empty" */;
  input clk;
  input [39:0]din;
  input wr_en;
  input rd_en;
