...
#
# Generated by export_simulation on Wed Oct 06 09:39:12 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './commandFIFO.sh' script.

./commandFIFO.sh -reset_run
...
./commandFIFO.sh -noclean_files

For more information on the script, please type './commandFIFO.sh -help'.
